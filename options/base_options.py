...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--num_options_each_layer', type=int, default=4)
        # model parameters
        ...
        parser.add_argument('--num_shared', type=int, default=2, help='# of shared layers')
        ...
        parser.add_argument('--max_encode_features', type=int, default=10000, help='# of encoder filters in the first conv layer')
