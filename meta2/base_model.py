...
class BaseModel:
    def __init__(self,input_shape,device,sections:list) -> None:
        ...
        #print(input_shape)
        self.device=device
        self.dummy_input=torch.zeros(1,*input_shape,device=self.device)
    ...
    def forward(self,data,track_loss):
        ...
        for section in self.sections:
            ...
            last_features_shape=last_features.shape
            last_features=section.features[0].view(1,*last_features_shape)
